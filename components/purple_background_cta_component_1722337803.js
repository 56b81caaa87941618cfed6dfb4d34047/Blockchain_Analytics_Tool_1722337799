...
Vue.component("purple_background_cta_component_1722337803", {
    template: `
    <section id="cta-section-container" class="flex">
        <div id="sidebar" class="w-64 bg-gray-800 text-white p-4">
            <nav>
                <ul>
                    <li class="mb-2"><a href="#" class="hover:text-blue-300">Home</a></li>
                    <li class="mb-2"><a href="#" class="hover:text-blue-300">About</a></li>
                    <li class="mb-2"><a href="#" class="hover:text-blue-300">Contact</a></li>
                </ul>
            </nav>
        </div>
        <div id="section-container" class="flex-1 max-w-6xl mx-auto px-4 sm:px-6 bg-gray-900">
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-3xl overflow-hidden bg-gradient-to-br from-blue-900 to-purple-900 shadow-lg">
                <!-- Radial gradient -->
                <div id="radial-gradient" class="absolute flex items-center justify-center top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 pointer-events-none -z-10 w-1/3 aspect-square" aria-hidden="true">
                    <div id="radial-gradient-outer" class="absolute inset-0 translate-z-0 rounded-full blur-150 opacity-70 bg-blue-500"></div>
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium text-blue-300 pb-3">Dive Deep into Blockchain Data</div></div>
                    <div class="flex" id="content-title-container"><h2 id="content-title" class="flex-1 h2 text-white pb-4">Uncover Blockchain Insights</h2></div>
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8 text-gray-300">Gain invaluable intelligence on the latest blockchain activities with our cutting-edge analytics platform. Uncover trends, identify opportunities, and stay ahead of the curve.</p></div>
                    <a id="content-cta-button" href="#0" class="btn transition duration-150 ease-in-out group bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-full hover:shadow-lg hover:from-blue-600 hover:to-purple-600">Get Started <span id="content-cta-arrow" class="tracking-normal group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1 text-blue-200">-&gt;</span></a>
                    
                    <button id="submit-button" class="btn transition duration-150 ease-in-out mt-4 bg-gradient-to-r from-purple-500 to-blue-500 text-white px-6 py-3 rounded-full hover:shadow-lg hover:from-purple-600 hover:to-blue-600">Submit</button>
                </div>
            </div>
        </div>
    </section>`,
        data() {
            return {
                ...
                stopColorSecondaryStyle: "#8B5CF6",
