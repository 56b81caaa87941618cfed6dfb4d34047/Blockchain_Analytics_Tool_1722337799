...
Vue.component("purple_feature_grid_component_1722337803", {
    ...
    <div class="flex">
        <!-- Sidebar -->
        <div class="w-200px bg-gray-800 h-screen p-20px">
            <nav>
        ...
        <div class="flex-1">
            <!-- Features list -->
            <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-20px">
                <!-- Feature -->
                <div id="feature-1">
                    <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
                        ...
                        <div class="flex" id="feature-1-title-container"><h4 id="feature-1-title" class="flex-1 font-medium" :class="textSecondaryStyle">Real-Time Blockchain Monitoring</h4></div>
                    </div>
                    <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our advanced blockchain monitoring system. Receive instant alerts and notifications for new blocks, transactions, and events across multiple blockchains.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-2">
                    <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                        ...
                        <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 font-medium" :class="textSecondaryStyle">Powerful Data Analytics</h4></div>
                    </div>
                    <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Leverage our cutting-edge data analytics tools to gain valuable insights from blockchain data. Identify trends, patterns, and anomalies to make informed decisions.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-3">
                    <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                        ...
                        <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 font-medium" :class="textSecondaryStyle">Customizable Dashboards</h4></div>
                    </div>
                    <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Create tailored dashboards to visualize and track the metrics that matter most to your business. Customize layouts, charts, and widgets to suit your specific needs.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-4">
                    <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                        ...
                        <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Seamless Integration</h4></div>
                    </div>
                    <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform seamlessly integrates with your existing systems and workflows. Connect with popular blockchain networks, APIs, and tools for a streamlined experience.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-5">
                    <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                        ...
                        <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 font-medium" :class="textSecondaryStyle">Robust Security Measures</h4></div>
                    </div>
                    <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Rest assured that your data is protected with our robust security measures. We employ industry-standard encryption, access controls, and auditing to safeguard your information.</p></div>
                </div>
                <!-- Feature -->
                <div id="feature-6">
                    <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                        ...
                        <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 font-medium" :class="textSecondaryStyle">Scalable and Flexible</h4></div>
                    </div>
                    <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our blockchain analytics solution is built to scale with your growing needs. Easily add new blockchains, adjust resources, and expand your monitoring capabilities as required.</p></div>
                </div>
            </div>
        </div>
    </div>`,
